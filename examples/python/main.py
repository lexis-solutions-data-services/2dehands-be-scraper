"""
Example: How to call the 2dehands-be-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/2dehands-be-scraper
...
def run_actor():
    """Run the 2dehands-be-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/2dehands-be-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://www.2dehands.be/q/samsung"}],
            "maxItems": 10,
        }
    )
